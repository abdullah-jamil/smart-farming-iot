...
// ********************************************database connection *****************************************************  
  ...
  // ****************************************database access*************************************     
       ...
       $sql = "SELECT * from irrigation order by id";     // access sql      
 ...
 // ************************display/ show***************************       		
	   ...
	   echo "<table border='1'>";
       echo "<tr><th>ID</th><th>TEMPERATURE</th><th>HUMIDITY</th><th>SOIL MOISTURE</th><th>RECORD HISTORY</th></tr>";
       while($row = mysqli_fetch_assoc($retval))
        {  
            ...
            echo "<td style='vertical-align: middle; text-align: center;'>{$row['SOILMOISTURE']}</td>";
