...
if(isset($_GET['TEMP'])  AND isset($_GET['HUMIDITY']) AND isset($_GET['SOIL']) AND isset($_GET['token'])  )
   {                       
    ...
    //                                   }
			 //                  }
						   ...
						   $sql = "INSERT INTO irrigation2 (TEMPERATURE,HUMIDITY,SOILMOISTURE,updated_on) VALUES ('$temp_s1','$temp_s2','$temp_s3',' $currentISTTimestamp')";
						   
						   $sql2="update irrigation set TEMPERATURE='$temp_s1', HUMIDITY=' $temp_s2',SOILMOISTURE='$temp_s3' where id ='1' ";
