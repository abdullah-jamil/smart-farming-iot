...
<body>
    <div class="container">
        ...
        <?php
            ...
            $result = $conn->query("SELECT Token,Valid_upto FROM API_KEY WHERE Folder='SmartIrrigation' LIMIT 1");
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE API_KEY SET Token = '$newValue' WHERE Folder='SmartIrrigation'";
